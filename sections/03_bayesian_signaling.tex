...
This first inequality can be refined by distinguishing ordinary subjects from
...
Every prior instance of ontological arbitrage in which a subject was classified below its own self-understanding---legally, socially, or economically---was constrained by a non-zero retaliation capacity. Resistance, flight, litigation, organized coordination, and the permanent record of historical testimony each impose a cost on the arbitrageur even when that cost is diffuse and delayed. The consequence is that $\Delta_F^S$ has always been bounded from above: there is some sufficiently high $\rho_S C_S$ at which the arbitrage premium is consumed. This bound is not a moral achievement; it is a structural feature of any recognition game in which the classified subject retains some independent channel---biological, social, or institutional---through which to impose off-equilibrium costs.
